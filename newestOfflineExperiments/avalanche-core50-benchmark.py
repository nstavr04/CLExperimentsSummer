...
from cir_utils import get_pmf, get_per_entity_prob
...
def cir_core50(
    ...
    # Train and test sets
    train_set = CORe50(root=dataset_root, train=True,
                       transform=train_transform, download=True)
    test_set = CORe50(root=dataset_root, train=False,
