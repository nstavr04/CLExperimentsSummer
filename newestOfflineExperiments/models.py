...
class ContinualLearningModel:
    ...
    def buildBaseHidden(self,hidden_layers=0):
        ...
        self.feature_extractor.compile(optimizer=tf.keras.optimizers.RMSprop(learning_rate=0.001), loss='categorical_crossentropy',
                                       metrics=['accuracy'])
    ...
    def buildHeadHidden(self, sl_units=32, hidden_layers=0):
        ...
        self.head.compile(optimizer=tf.keras.optimizers.RMSprop(learning_rate=0.001), loss='sparse_categorical_crossentropy',
                          metrics=['accuracy'])    
    ...
    def buildCompleteModel(self):
        ...
        self.model.compile(optimizer=tf.keras.optimizers.RMSprop(learning_rate=0.001), loss='sparse_categorical_crossentropy',
                           metrics=['accuracy'])
